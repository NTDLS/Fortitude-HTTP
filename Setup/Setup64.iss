...
[Files]
 ...
 Source: "..\AutoUpdate\x64\Release\AutoUpdate.Exe";          DestDir: "{app}";             Components: Base\AutoUpdate;      Flags: RestartReplace;
 Source: "AutoUpdate.xml";                                    DestDir: "{app}";             Components: Base\AutoUpdate;      Flags: IgnoreVersion;
 Source: "..\Source\Console\Release\x64\FortitudeMgt.exe";    DestDir: "{app}";             Components: Base\Management;      Flags: IgnoreVersion;
 Source: "..\Source\Service\Release\x64\FortitudeSvc.exe";    DestDir: "{app}";             Components: Server;               Flags: IgnoreVersion;
 Source: "..\Source\Console\Release\x64\FortitudeMgt.pdb";    DestDir: "{app}";             Components: Base\Debugging;       Flags: IgnoreVersion;
 Source: "..\Source\Service\Release\x64\FortitudeSvc.pdb";    DestDir: "{app}";             Components: Base\Debugging;       Flags: IgnoreVersion;
 ...
 Source: "Data\Server\preConfigured\64\*.*";                  DestDir: "{app}\Data";        Components: Server\PreConfigured; Flags: OnlyIfDoesntExist;
